...
# Basic context menu installation using shell script and manual registration

echo "Installing basic EisenVault context menu..."
...
# Create a very simple workflow document
...
echo "Basic context menu installed successfully!"
